...
grid_spec = (230 * 2,230 * 2)
#grid_spec = (420,420)
box_length = (20,20)
use_grid = p.Grid(box_length=box_length, grid_spec = grid_spec)
#box_length = (37,37)
#grid_spec = (760,760)

smear = 0.1632993161855452
ps = p.PolymerSystem(monomers, polymers, spec_dict, FH_terms,
        use_grid, smear, salt_conc=0.020, integration_width = 1/7)
...
fig.suptitle('Uncharged 50% CART 1:1 Lipid:Charge')
