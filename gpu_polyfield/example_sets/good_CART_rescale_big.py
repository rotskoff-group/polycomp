...
relax_rates = cp.array([16 * 1 * corr * ps.grid.dV]*(ps.w_all.shape[0])) / dens_corr
print(relax_rates)
#relax_rates[0] *= 2
relax_temps = cp.array([0.01]*(ps.w_all.shape[0]))  * dens_corr
