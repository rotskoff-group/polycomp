...
# get the average value of the last 400 points in each trajectory, using only
# columns 2 and 3
...
print(nums)
ax.scatter(
    [m[0].real for m in means], nums, label="Supernatant Concentration", color="blue"
)
ax.scatter(
    [m[1].real for m in means], nums, label="Coacervate Concentration", color="red"
)
