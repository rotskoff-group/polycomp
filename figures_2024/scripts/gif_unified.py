...
im[0][0] = axes[0, 0].imshow(B_traj.get(), cmap=yellow_cmap, vmin=0, alpha=0.6)
im[0][0] = axes[0, 0].imshow(A_traj.get(), cmap=red_cmap, vmin=0, alpha=0.6)
im[0][0] = axes[0, 0].imshow(L_traj.get(), cmap=green_cmap, vmin=0, alpha=0.6)
im[2][1] = axes[2, 1].imshow(S_traj.get(), cmap=blue_cmap, vmin=0, alpha=0.6)
im[1][0] = axes[1, 0].imshow(B_traj.get(), cmap=yellow_cmap, vmin=0, alpha=0.6)
im[1][1] = axes[1, 1].imshow(A_traj.get(), cmap=red_cmap, vmin=0, alpha=0.6)
im[2][0] = axes[2, 0].imshow(L_traj.get(), cmap=green_cmap, vmin=0, alpha=0.6)
...
im[0][1] = axes[0, 1].imshow(
    np.flip(np.roll(max_species_indices_np, 240, axis=1), axis=0),
    cmap=cmap,
    origin="lower",
)
