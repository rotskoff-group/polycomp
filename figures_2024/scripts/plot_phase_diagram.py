...
fig, axes = plt.subplots(
    nrows=nrows, ncols=ncols, figsize=(8 / 1.1, 20 / 3.3), dpi=1000
)
...
for i in range(ncols):
    for j in range(nrows):
        ...
        # Plot the species with the largest value at each point using custom colormap
...
cbar = plt.colorbar(
    scatter_plot, ticks=[3 / 8.0, 9 / 8.0, 15 / 8.0, 21 / 8.0], aspect=25
)
cbar.set_ticklabels(
...
for i, ax in enumerate(axes.flat):
    ...
    ax.text(
        -0.15, 1.15, label, transform=ax.transAxes, va="top", ha="left", fontsize=17
    )
...
colors = [
    (0.9803921568627451, 0.5019607843137255, 0.4470588235294118, 0),
...
colors = [
    (0.5294117647058824, 0.807843137254902, 0.9215686274509803, 0),
    (0.5294117647058824, 0.807843137254902, 0.9215686274509803, 1),
]  # White to Skyblue
...
colors = [
    (0.5294117647058824, 0.807843137254902, 0.9215686274509803, 0),
    (0.5294117647058824, 0.807843137254902, 0.9215686274509803, 0.5),
]  # White to Skyblue (half opacity)
